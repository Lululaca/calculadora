...
frame_tela = Frame(janela, width=335, heigh=50, bg=cor2)
frame_tela.grid(row=0, column=0)
frame_corpo = Frame(janela, width=340, heigh=378)
...
#craindo label// basicamnete as informações na tela
...
b_1 = Button(frame_corpo,command=limpa_tela, text="C", width=11, height=2, bg=cor3, font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE )
b_1.place(x=0, y=0)
b_2 = Button(frame_corpo, command= lambda: entra_valores('%'), text="%", width=5, height=2, bg=cor3,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
b_2.place(x=118, y=0)
b_3 = Button(frame_corpo, command= lambda: entra_valores('/'), text="/", width=5, height=2, bg=cor4, fg=cor5,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
b_3.place(x=177, y=0)
...
b_7 = Button(frame_corpo, command= lambda: entra_valores('*'), text="*", width=5, height=2, bg=cor4, fg=cor5,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
...
b_11 = Button(frame_corpo, command= lambda: entra_valores('-'), text="-", width=5, height=2, bg=cor4, fg=cor5,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
...
b_15 = Button(frame_corpo, command= lambda: entra_valores('+'), text="+", width=5, height=2, bg=cor4, fg=cor5,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
b_15.place(x=177, y=156)

b_16 = Button(frame_corpo, command= lambda: entra_valores('0'),text="0", width=11, height=2, bg=cor3, font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE )
b_16.place(x=0, y=208)
b_17 = Button(frame_corpo, command= lambda: entra_valores('.'), text=".", width=5, height=2, bg=cor3,  font=('Ivy 13 bold'),relief=RAISED, overrelief=RIDGE)
